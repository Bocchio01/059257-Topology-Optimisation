...
pdfsubject={Structural optimization of 2D discrete truss structures},
...
\title{Topology Optimization \\ Structural optimization of a truss structure}
...
\input{src/03 - cantilever_rod_structure.tex}
\input{src/04 - motorcycle_frame.tex}
