...
The goal of this section is to perform a topology optimization of a motorcycle frame shown in Figure \ref{fig:motorcycle_frame}, minimizing the compliance $C$ by acting on the cross-sectional areas of the rods.
...
As can be observed, the structure is composed of $N_{nodes} = 17$ nodes and $N_{rods} = 55$ rods.
