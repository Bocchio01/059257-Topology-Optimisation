...
During the vehicle motion, the main sources of energy dissipation are mass (inertia), tire rolling resistance, and aerodynamic drag.
...
The goal of this project is to optimize the hub carrier by maximizing structural stiffness while imposing a mass constraint.
As will be discussed along the document, different load scenario and constraints are considered to ensure the hub carrier is able to withstand the forces generated during the competition.
