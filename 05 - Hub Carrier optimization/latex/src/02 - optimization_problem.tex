...
This choice is made to avoid the definition of complex initial geometries and not restrict the optimization algorithm to a specific pre-designed shape.
...
In Figure \ref{fig:design_domain}, the design domain is shown in blue, while the non-design domains (i.e., the hub carrier's connecting points with the rest of the vehicle) are shown in red.
...
The optimization variables are the density of each element in the design domain.
