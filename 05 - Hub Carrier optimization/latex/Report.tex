...
\hypersetup{
pdftitle={Hub Carrier optimization},
pdfsubject={Topology Optimization of a Hub Carrier},
...
\title{Topology Optimization \\ Hub Carrier optimization}
...
\input{src/02 - optimization_problem.tex}
