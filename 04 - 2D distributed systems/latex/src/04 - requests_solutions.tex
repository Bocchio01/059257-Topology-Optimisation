\section{Requests and solutions}
...
The optimized structures for the two different situations are shown in Figure \ref{fig:case3_1}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./img/MATLAB/req_3.pdf}
    \caption{Case 3: multiple load cases.}
    \label{fig:case3_1}
\end{figure}
